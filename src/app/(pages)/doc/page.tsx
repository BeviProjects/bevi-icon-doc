        ...
        <Article className="ds-flex flow-col-nw gap-md">
          ...
          <section>
            ...
            <p>
              ...
              <Link href="/icons">Ícones</Link>, ao observar todos os ícones,
              pode notar que é possível clicar para ver mais opções, e dentro
              delas navegar e copiar o que desejar para o seu projeto com o Bevi
              Icon.
            </p>
